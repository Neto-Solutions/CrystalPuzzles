...
export const Table = () => {
	return (
		<div className={styles.table}>
			<div className={classNames(styles.items, styles.item_1)}>№ п/п</div>
			<div className={classNames(styles.items, styles.item_2)}>
			...
			<div className={`${styles.items} ${styles['item_9']}`}>
				<p>Системность работы по совершенствованию программного обеспечения:</p>
