...
export default function CheckInPage({ login }) {
    ...
    return (
        <div className="app">
            <RouterTool />  {/*Don`t forget to remove it here and in Root*/}
            <Header />
                ...
                <div className="check_in_container">
                    ...
                    <form className="check_in_form">
                        ...
                        <label className="input_container">
                            ...
                            <select className="input_select" defaultValue="student">
                                <option className="input_option" value="student">Ученик</option>
                                <option className="input_option" value="trainer">Тренер</option>
                            </select>
                        </label>
                        {!login && <>
                            <label className="input_container">
                            ...
                            <label className="input_container">
                                <p className="input_description">Введите номер вашей группы или имя тренера</p>
                                <input className="input" type="text" />
                            </label >
                        </>}
                        ...
                        <div className="check_in_forget_password">
                            <a href="/#" className="check_in_forget_password_link">Забыли пароль?</a>
                        </div>
                        ...
                        <label className="input_container input_checkbox_container">
                            ...
                            <p className="input_description">
                                ...
                                <Link to="/confidence" className="check_in_confidence_politic_link">политикой конфиденциальности</Link>
                            </p>
                        </label>
                    ...
                    {login ? <>
                        <div className="check_in_btn_container">
                            <a href="/#" className="check_in_btn_label" htmlFor="reg_btn">Нет аккаунта?</a>
                            <div onClick={() => navigate("/registration")} className="check_in_btn" id="reg_btn">Зарегистрироваться</div>
                        </div>
                    </> : <>
                        <div className="check_in_btn_container">
                            <label className="check_in_btn_label" htmlFor="log_btn">Уже есть аккаунт?</label>
                            <div onClick={() => navigate("/login")} className="check_in_btn" id="log_btn">Войти</div>
                        </div>
                    </>}
                </div >
            </div>
