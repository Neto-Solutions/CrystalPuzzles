            ...
            <PageContainer.Body>
                ...
                <Link to="/#" className="general_kids_link">
                    <Card title={"Мои тренировки"}>
                        <span className="card_description">тренер оценил вашу тренировку</span>
                    </Card>
                </Link>
                <Link to="/#" className="general_kids_link">
                    ...
                    <Card title={"Мои расписание на сегодня"} >
                        <div className="general_kids_shedule">
                            <div className="general_kids_shedule_item">
                                <span className="general_kids_shedule_item_time">12:50</span><span> - </span><span>1 площадка,</span>
                                <span>тренер - Ильина Анастасия</span>
                            </div>
                            <div className="general_kids_shedule_item">
                                <span className="general_kids_shedule_item_time">14:50</span><span> - </span><span>1 площадка,</span>
                                <span>тренер - Ильина Анастасия</span>
                            </div>
                        </div>
                    </Card>
