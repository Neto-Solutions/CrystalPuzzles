            ...
            <div className="checklist_header_base_cont">
                <main className="checklist_base_cont">
                  ...
                  <section className="checklicst_levels_cont">
                    ...
                    <div className="checklicst_area">Площадка:  <span className="checklicst_trainer_area_descpition">2- Бережковская набережная, д. 20, стр. 6</span></div>
                  ...
                  <section className="checklicst_choose_panel">
                    <div className="checklicst_fullname">Дмитриева Анастасия Алексеевна</div>
                    <ChooseButton className="checklicst_choose_student" title="Выберите учеников" downArrow />
                    <ChooseButton className="checklicst_choose_group" title="Выберите группу" downArrow />
                    <ChooseButton className="checklicst_choose_level" title="Выберите уровень" downArrow />
