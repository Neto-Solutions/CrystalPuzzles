        ...
        <aside className="sidebar_container">
            ...
            <nav className="sidebar_navigation">
                <select className="sidebar_navigation_options" defaultValue="main">
                    <option className="sidebar_navigation_item" value="main">ГЛАВНАЯ</option>
                    <option className="sidebar_navigation_item" value="progress">Графики прогресса</option>
                    <option className="sidebar_navigation_item" value="analytics">Аналитика</option>
                    <option className="sidebar_navigation_item" value="tables">Таблицы</option>
                    <option className="sidebar_navigation_item" value="feedback">Обратная связь</option>
                </select>
            </nav>
            <div className="sidebar_decor_line"></div>
