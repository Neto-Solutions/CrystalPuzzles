const lessons = [
	{
		id: '66b0cd82c856a75cd22b3b01',
		place: {
			id: '66b0cce0c856a75cd22b3b00',
			name: 'Спортзал',
			description: ''
		},
		trainer: {
		...
		trainer_comment: '',
		checkList: {
			id: '66b0cd82c856a75cr22b3b00',
			exercises: [
				{
					id: '66b0cd82c856a75cd22b3b02',
					name: 'Стойка на месте без посторонней помощи',
					img: 1,
					isComplete: true
				},
				{
					id: '66b0cd82c856a75cd22b3b03',
					name: 'Самостоятельный подъем после падения',
					img: 2,
					isComplete: false
				},
				{
					id: '66b0cd82c856a75cd22b3b04',
					name: 'Проезд на 2 ногах',
					img: 3,
					isComplete: true
				},
				{
					id: '66b0cd82c856a75cd22b3b05',
					name: 'Саночки',
					img: 4,
					isComplete: true
				},
				{
					id: '66b0cd82c856a75cd22b3b06',
					name: 'Змейка вперед',
					img: 5,
					isComplete: false
				}
