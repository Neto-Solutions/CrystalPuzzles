            ...
            <div className={show ? "router_tool" : "router_tool router_tool_hide"}>
                <div className="router_tool_role_container">
                    {roles.map((el, index) => <>
                        <div
                            key={index}
                            className={el === role ? "router_tool_role router_tool_role_active" : "router_tool_role"}
                            onClick={() => dispatch({ type: "SET_ROLE", payload: el }, navigate("/"))}>
                            {el}
                        </div>
                    </>)}
                </div>
